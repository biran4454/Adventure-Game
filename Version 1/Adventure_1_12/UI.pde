public class UI{
  UI(){
    ...
    controlKey = new ControlKey("This text should not appear");
  }
  ...
  public void setKeyNotification(String text){
    controlKey = new ControlKey(text);
  }
  public void deleteKeyNotification(){
    controlKey = new ControlKey("This text should not appear");
  }
  public void drawNotifications(){
    ...
    if(controlKey.text != "This text should not appear"){
      controlKey.drawNotification();
    }
  }
...
public class List{
  ...
  private String[][] sortItems(ArrayList<Item> items){
    ...
    String[][] finish = new String[resultNames.size() + 1][3];
